...
@section('content')
    ...
    <div class="formularz">
        ...
        @csrf
            <table align="center">
                <tr>
                    <td><label>Adres e-mail<sup>*</sup>:<br><input type="email" id="email" name="email" value="{{ old('email') }}"></label></td>
            ...
            <div class="przycisk_formularz"><input type="checkbox" id="regulamin" name="terms" {{ old('terms') ? 'checked' : '' }} /><label for='regulamin' >Akceptuję regulamin</label></div>
